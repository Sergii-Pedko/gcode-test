/*Создадим функцию, которая будет создавать независимые месенджеры 

-------------------   ЭКСПОРТ ф-ций ПО УМОЛЧАНИЮ --------------------------

      1) СТРЕЛОЧНАЯ ф-ция:  const createMessenger = () => { ... };
                          export default createMessenger;

      2) Обычная ф-ция: export default function createMessenger() { ... };
--------------------------------------------------------------------------- */ 
